...
impl Computer {
    ...
    #[allow(dead_code)]
    pub fn print(&mut self, value: char) {
        self.push_input(value as Unit);
    }

    #[allow(dead_code)]
    pub fn println(&mut self, value: String) {
        value.chars().for_each(
            |c| self.print(c)
        );

        self.print(10 as char);
    }
    ...
    #[allow(dead_code)]
    pub fn pop_output(&mut self) -> Option<Unit> {
